...
import com.gmail.murcisluis.spigot.api.BaseAPI;
import com.gmail.murcisluis.spigot.api.BaseSpigot;
...
public abstract class AbstractCommandSpigot extends Command implements CommandBaseSpigot {
    ...
    protected static final BaseSpigot PLUGIN = (BaseSpigot) BaseAPI.get();
